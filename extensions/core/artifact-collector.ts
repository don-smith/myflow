/**
 * myflow-flavoured artifact collection — the `.myflow/artifacts/<bucket>/<file>.md`
 * convention all @myflow/pi skills emit into. This module owns the
 * convention; the framework (`@myflow/workflow`) ships only
...
// ---------------------------------------------------------------------------
// OutputSpec — pre-bundled wiring @myflow/pi workflows plug in
// ---------------------------------------------------------------------------

/** Default @myflow/pi produces outcome — bucket-agnostic text scan + frontmatter parse. */
