...
import { applyOverride, registerRpivModelsCommand, removeOverride } from "./myflow-models/index.js";
...
function makePi() {
	...
	const registerCommand = vi.fn(
		(name: string, opts: { handler: (args: string, ctx: ExtensionContext) => Promise<void> }) => {
			if (name === "myflow-models") cmdHandler = opts.handler;
		},
	);
	...
	const getCommands = vi.fn(() => [
		...
		{ name: "myflow-models", description: "Configure models", source: "extension", sourceInfo: stubSourceInfo },
	]);
	return {
...
describe("/myflow-models — defaults flow", () => {
...
describe("/myflow-models — skills flow (live registry)", () => {
...
describe("/myflow-models — effort picker for reasoning models", () => {
...
describe("/myflow-models — first-class off vs inherit", () => {
...
describe("/myflow-models — cache invalidation", () => {
...
describe("/myflow-models — checkmark display", () => {
...
describe("/myflow-models — override checkmarks", () => {
...
describe("/myflow-models — per-entry reset", () => {
...
describe("/myflow-models — save failure", () => {
...
describe("/myflow-models — committing returns to the parent list (not close)", () => {
