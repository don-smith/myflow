...
import type { SkillContract, SkillContractMap, Workflow } from "@myflow/workflow/registration";
import { acts, defineWorkflow, produces } from "@myflow/workflow/registration";
