...
<div align="center">
  <a href="https://github.com/don-smith/myflow/tree/main/packages/advisor">
    <picture>
      <img src="https://raw.githubusercontent.com/don-smith/myflow/main/packages/advisor/docs/cover.png" alt="advisor cover" width="50%">
    </picture>
  </a>
</div>

Let the model ask a stronger model for a second opinion before it acts. `advisor` adds the `advisor` tool and `/advisor` slash command to [Pi Agent](https://github.com/badlogic/pi-mono) - the working model can hand the full conversation to a reviewer (e.g. Opus) and resume with its plan, correction, or stop signal.

![Advisor model selector](https://raw.githubusercontent.com/don-smith/myflow/main/packages/advisor/docs/advisor.jpg)
...
[![npm version](https://img.shields.io/npm/v/@myflow/advisor.svg)](https://www.npmjs.com/package/@myflow/advisor)
