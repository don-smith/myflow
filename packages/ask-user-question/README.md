...
<div align="center">
  <a href="https://github.com/don-smith/myflow/tree/main/packages/ask-user-question">
    <picture>
      <img src="https://raw.githubusercontent.com/don-smith/myflow/main/packages/ask-user-question/docs/cover.png" alt="ask-user-question cover" width="50%">
    </picture>
  </a>
</div>

Let the model ask you structured clarifying questions instead of guessing. `ask-user-question` adds the `ask_user_question` tool to [Pi Agent](https://github.com/badlogic/pi-mono) - a tabbed dialog with single- and multi-select questions, side-by-side previews, per-option notes, and a Submit tab that reviews answers before they go back to the model.

![Side-by-side code preview](https://raw.githubusercontent.com/don-smith/myflow/main/packages/ask-user-question/docs/code-preview.jpg)
...
| | |
|---|---|
| ![Single-question dialog](https://raw.githubusercontent.com/don-smith/myflow/main/packages/ask-user-question/docs/single-question.jpg) | ![Multi-tab + ASCII preview](https://raw.githubusercontent.com/don-smith/myflow/main/packages/ask-user-question/docs/multi-tab-preview.jpg) |
| ![Multi-select with checkboxes](https://raw.githubusercontent.com/don-smith/myflow/main/packages/ask-user-question/docs/multi-select.jpg) | ![Submit tab review](https://raw.githubusercontent.com/don-smith/myflow/main/packages/ask-user-question/docs/submit-tab.jpg) |
| ![Localized UI - German](https://raw.githubusercontent.com/don-smith/myflow/main/packages/ask-user-question/docs/localized-german-ui.jpg) | |

## Install

```bash
pi install npm:@myflow/ask-user-question
```
...
`ask-user-question` works standalone - install only this package and you get the full English UI. Install `@myflow/i18n` alongside it to flip sentinel labels, dialog hints, review-tab heading, and chat-summary lines to your active locale:
...
[![npm version](https://img.shields.io/npm/v/@myflow/ask-user-question.svg)](https://www.npmjs.com/package/@myflow/ask-user-question)
