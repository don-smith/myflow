 ...
 * config): malformed JSON, EISDIR, or a hard schema violation all
...
// config's. The leaf schema (`GuidanceFieldsSchema`) is sibling-agnostic
// and lives in config; this file only composes the tool-namespaced shell
// around it.
...
const CONFIG_PATH = configPath("web-tools");
