...
import { canonicalJson, lifecycleAttemptId } from "../../myflow/scripts/lib/lifecycle-contract.mjs";
import {
  readLifecycleJournal,
  validateLifecycleJournal,
} from "../../myflow/scripts/lib/lifecycle-store.mjs";
...
async function readFeedbackRecords(repositoryRoot, workstreamId, attemptId, options) {
  try {
    const { privateObservationRoot } = await import("./lib/private-store.mjs");
