...
Don't invent jargon. Use the words a developer would say out loud: "move", "delete", "a budget that only decreases", not "evacuate", "ratchet", or "endgame". A named pattern is fine when the doc says what it means the first time. Add new offenders to this skill's abstract-metaphor guidance with their replacement.
...
- Cut the slop patterns from every doc this skill touches: AI vocabulary, filler, hedging, and formatting tells.
